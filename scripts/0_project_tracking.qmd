...
# Add counts
text(3, 5, paste("Boreal Only\n", boreal_count), cex = 0.5)
text(7, 5, paste("Tundra Only\n", tundra_count), cex = 0.5)
text(5, 5, paste("Common\n", common_count), cex = 0.5)

# Add total counts
text(5, 8.5, paste("Total Species:", length(unique(all_filtered_species$SpeciesName))), cex = 1.3)
text(3, 8, paste("Total Boreal:", length(boreal_species)), cex = 0.2)
text(7, 8, paste("Total Tundra:", length(tundra_species)), cex = 0.2)
...
#| fig-cap: "Distribution of discrepant species"
#| fig-width: 7
#| fig-height: 6
#| out-width: "100%"
#| echo: false
