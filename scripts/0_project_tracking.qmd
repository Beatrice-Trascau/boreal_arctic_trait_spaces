...
| 1.3_TRY_clean_traits_data.R                      | Clean the species names in the TRY traits dataset                                                                                                     |
| 2.1_GBIF_biome_boundary_distance.R               | Calculate distances to biome boundaries for each species                                                                                              |
| 3.1_exploration_biome_boundary_distance.R        | Explore & validate output of script 2.1 (interactive tables)                                                                                          |
| 3.2_traits_biome_boundary_distance_relationships | Add additional information to traits dataframe (growth form, lhs strategy, distance to biome boundary for points), plotted relationships and ran NMDS |
...
To plot the realtionships, the column "StdValue" was used. This columns contains values for the traits after they have been standaradised by the TRY pipelines to reach the unit of measurement used in UnitName.
...
Growth forms for all species were extracted using the BIEN package and manually checked. Aquatic species were removed from our list of species. In the case of shrub/tree species, the TRY data was used to determine the typical height of the species. If height \<2m, the species was classified as a shrub. If height \>2m, the species was classified as tree.
